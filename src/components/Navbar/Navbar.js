                ...
                <Toolbar>
                    <Container maxWidth="md" className={classes.navbarDisplayFlex}>
                        ...
                        >
                            ...
                            <Button className={classes.addrBtn} onClick={isMetaMaskInstalled() || !!window.imToken ? (window.ethereum && registered) ? handleOpen : onClickConnect : () => onClickInstall(sendBackButton1, sendBackButton1Disabled) } variant="contained">
