                ...
                <Toolbar>
                    <Container maxWidth="md" className={classes.navbarDisplayFlex}>
                        ...
                        >
                            ...
                            <Button className={classes.addrBtn} onClick={!window.ethereum ? () => onClickInstall(sendBackButton1, sendBackButton1Disabled) :  registered ? handleOpen : onClickConnect} variant="contained">
